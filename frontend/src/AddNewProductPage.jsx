      ...
      <div className="homepage">
        ...
        <main className="main-content">
          ...
          <section className="empty-state">
            ...
            <div className="empty-content" style={{ opacity: showModal ? 0.3 : 1 }}>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div className="form-group-modal">
                    ...
                    <input name="productName" value={formData.productName} onChange={handleChange} placeholder="CakeZone Walnut Brownie" />
                  </div>
                  <div className="form-group-modal">
                    <label>Product Type</label>
                    <input name="productType" value={formData.productType} onChange={handleChange} placeholder="Type..." />
                  </div>
                  <div className="form-group-modal">
                  ...
                  <div className="form-group-modal">
                    ...
                    <div className="upload-box">
                      ...
                      <button style={{ background: 'transparent', border: 'none', color: '#374151', fontWeight: '600', marginTop: '4px', cursor: 'pointer' }}>
                        Browse
                      </button>
                    </div>
                  </div>
